import {Modal, View, Text, Linking, Image, TouchableOpacity, StyleSheet, Dimensions} from 'react-native'
...
const WarningModalJanPatrika = (props) => {
    const dispatch = useDispatch()
    const navigation = useNavigation()
    return (
        <Modal visible={true} transparent onRequestClose={() => props.closeJanPatrikaModal()} animationType="slide">
        <View style={styles.modalSection}>
          <View style={styles.modalContainer}>
            <TouchableOpacity onPress={() => props.closeJanPatrikaModal()} style={{ position: 'absolute', right: 5, top: 5 }}>
  ...
  You can cancel if you don’t want to continue.</Text>
            <View style={{ flexDirection: 'row', marginTop: 20, width: '100%', justifyContent: 'space-around' }}>
              ...
              <TouchableOpacity
              onPress={() => props.closeJanPatrikaModal()}
              ...
              <TouchableOpacity
              onPress={() => {
                Linking.openURL(props.pdfUrl)
                props.closeJanPatrikaModal()
              }}
...
export default WarningModalJanPatrika