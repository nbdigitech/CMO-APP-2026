...
const WarningModalImportantLink = (props) => {
    const dispatch = useDispatch()
    const navigation = useNavigation()
    return (
        <Modal visible={true} transparent onRequestClose={() => props.closeNoticeModal()} animationType="slide">
        <View style={styles.modalSection}>
          <View style={styles.modalContainer}>
            <TouchableOpacity onPress={() => props.closeNoticeModal()} style={{ position: 'absolute', right: 5, top: 5 }}>
  ...
  You can cancel if you don’t want to continue.</Text>
            <View style={{ flexDirection: 'row', marginTop: 20, width: '100%', justifyContent: 'space-around' }}>
              ...
              <TouchableOpacity
              onPress={() => props.closeNoticeModal()}
              ...
              <TouchableOpacity
              onPress={() => {
                Linking.openURL(props.noticePdfUrl)
...
export default WarningModalImportantLink